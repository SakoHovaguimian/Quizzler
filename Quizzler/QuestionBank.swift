...
//  Quizzler
//
//  Created by Sako Hovaguimian on 5/10/18.
...
class QuestionBank {
    ...
    init() {
        ...
        list.append(Question(text: "A 100lbs of feathers ways more than a 100lbs of bricks?", correctAnswer: false))
        ...
        list.append(Question(text: "Does Lebron belong on the Lakers?", correctAnswer: false))
